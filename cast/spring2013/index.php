...
<html>
  <head>
    ...
    <title>Theatre Rice - Cast of Spring 2013</title>
  </head>
<body>
...
#A url of the form tr=cast_spring2013&menu=menu_cast goes to the home page
#A url of the form tr=cast_spring2013&menu=menu_cast&castmember=<name> goes to that member's page
#
...
if ( $castmember == NULL ) {
    include "list.php";	//This is the page it defaults to
